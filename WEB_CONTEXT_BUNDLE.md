...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0503-questions-in-geometric-group-theory-q-85d8d61b",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0503-b6b153103c2f",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0503"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Ed Taylor) Does there exist a constant c > 0 such that the limit set of every non-classical Schottky group has Hausdorff dimension ≥c.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 5.3",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "f43881aadff264417e0c8775bbba6df6d0c62690c3f6ebab6ec8dc18d5f358ef"
}
```
